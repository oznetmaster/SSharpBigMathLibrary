...
namespace BigMath.Utils
	...
	public static class ArrayUtils
		...
		private static readonly byte[] CharToByteLookupTable =
			...
			,
		...
		public static int GetNonZeroLength (this byte[] bytes)
			{
			return GetNonZeroLength (bytes, null);
			}
		/// <summary>
		///     Get length of serial non zero items.
		/// </summary>
		...
		/// <returns>Length of serial non zero items.</returns>
		public static int GetNonZeroLength (this byte[] bytes, bool? asLittleEndian)
#else
		/// <summary>
		///     Get length of serial non zero items.
		/// </summary>
		...
		/// <returns>Trimmed array of bytes.</returns>
		public static byte[] TrimZeros (this byte[] bytes, bool? asLittleEndian)
#else
		/// <summary>
		///     Trim zero items.
		/// </summary>
		...
		public static string ToHexString (this byte[] bytes)
			{
			return ToHexString (bytes, true, 0, false, false);
			}
		/// <summary>
		///     Converts array of bytes to hexadecimal string.
		/// </summary>
		...
		/// <param name="caps">Capitalize chars.</param>
		/// <returns>Hexadecimal string representation of the bytes array.</returns>
		public static string ToHexString (this byte[] bytes, bool caps)
			{
			return ToHexString (bytes, caps, 0, false, false);
			}
		/// <summary>
		///     Converts array of bytes to hexadecimal string.
		/// </summary>
		...
		/// <returns>Hexadecimal string representation of the bytes array.</returns>
		public static string ToHexString (this byte[] bytes, bool caps, int min)
			{
			return ToHexString (bytes, caps, min, false, false);
			}
		/// <summary>
		///     Converts array of bytes to hexadecimal string.
		/// </summary>
		...
		/// <returns>Hexadecimal string representation of the bytes array.</returns>
		public static string ToHexString (this byte[] bytes, bool caps, int min, bool spaceEveryByte)
			{
			return ToHexString (bytes, caps, min, spaceEveryByte, false);
			}
		/// <summary>
		///     Converts array of bytes to hexadecimal string.
		/// </summary>
		...
		/// <returns>Hexadecimal string representation of the bytes array.</returns>
		public static string ToHexString (this byte[] bytes, bool caps, int min, bool spaceEveryByte, bool trimZeros)
#else
		/// <summary>
		///     Converts array of bytes to hexadecimal string.
		/// </summary>
		...
		/// <param name="caps">Capitalize chars.</param>
		/// <returns>Hexadecimal string representation of the bytes array.</returns>
		public static string ToHexString (this ArraySegment<byte> bytes, bool caps)
			{
			return ToHexString (bytes, caps, 0, false, false);
			}
		/// <summary>
		...
		/// <param name="min">Minimum string length. 0 if there is no minimum length.</param>
		/// <returns>Hexadecimal string representation of the bytes array.</returns>
		public static string ToHexString (this ArraySegment<byte> bytes, bool caps, int min)
			{
			return ToHexString (bytes, caps, min, false, false);
			}
		/// <summary>
		...
		/// <param name="spaceEveryByte">Space every byte.</param>
		/// <returns>Hexadecimal string representation of the bytes array.</returns>
		public static string ToHexString (this ArraySegment<byte> bytes, bool caps, int min, bool spaceEveryByte)
			{
			return ToHexString (bytes, caps, min, spaceEveryByte, false);
			}
		/// <summary>
		...
		/// <param name="trimZeros">Trim zeros in the result string.</param>
		/// <returns>Hexadecimal string representation of the bytes array.</returns>
		public static string ToHexString (this ArraySegment<byte> bytes, bool caps, int min, bool spaceEveryByte, bool trimZeros)
#else
		/// <summary>
		///     Converts array of bytes to hexadecimal string.
		/// </summary>
		...
		public static byte[] HexToBytes (this string hexString)
			{
			byte[] bytes;
			if (StringEx.IsNullOrWhiteSpace (hexString))
				bytes = new byte[0];
			else
				{
